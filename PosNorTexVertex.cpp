...
static std::array< VkVertexInputBindingDescription, 1 > bindings{
    VkVertexInputBindingDescription{
        ...
        .stride = sizeof(PosNorTexVertex), // how much data per vertex
...
static std::array< VkVertexInputAttributeDescription, 3 > attributes{
    ...
    VkVertexInputAttributeDescription{
        ...
        .offset = offsetof(PosNorTexVertex, Position), // offsetof() macro: Automatically calculates the byte offset of a member in a struct. This is safer than hardcoding numbers.
    },
    VkVertexInputAttributeDescription{
        .location = 1, 
        .binding = 0,
        .format = VK_FORMAT_R32G32B32_SFLOAT, // Reads 12 bytes as 3 × 32-bit floats (x, y, z). Shader receives: vec3
        .offset = offsetof(PosNorTexVertex, Normal), // offsetof() macro: Automatically calculates the byte offset of a member in a struct. This is safer than hardcoding numbers.
    },
    VkVertexInputAttributeDescription{
        .location = 2, 
        .binding = 0,
        .format = VK_FORMAT_R32G32_SFLOAT, // Reads 8 bytes as 2 × 32-bit floats (x, y). Shader receives vec2s
        .offset = offsetof(PosNorTexVertex, TexCoord), // offsetof() macro: Automatically calculates the byte offset of a member in a struct. This is safer than hardcoding numbers.
    },
};
